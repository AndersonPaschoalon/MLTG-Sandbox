...
Plotter.plot_inter_arrival_cdf(plot_data_list=plot_list, out_dir=out_dir)
Plotter.plot_inter_arrival_time_distribution(plot_data_list=plot_list, out_dir=out_dir)
Plotter.plot_bytes_cdf(plot_data_list=plot_list, out_dir=out_dir)
Plotter.plot_flow_cdf(plot_data_list=plot_list, out_dir=out_dir)
