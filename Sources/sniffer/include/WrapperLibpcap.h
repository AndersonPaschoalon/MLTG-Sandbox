...
extern volatile long int            gMaxNumberOfPackets;
extern volatile double              gTimeout;
extern volatile unsigned int        gPacketCounter;
extern volatile sig_atomic_t        gStopCapture;
extern volatile sig_atomic_t        gEndOfFile;
extern struct timeval               gFirstTimeStamp;
extern struct timeval               gCurrentTimeStamp;
extern TSQueue<NetworkPacket*>*     gPacketsQueue;
